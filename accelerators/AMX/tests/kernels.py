...
def cnn_inference_amx(NUM_BLOCKS=1):
...
def cnn_inference_mix(NUM_BLOCKS=1):
...
def mem_format_prop_avx(NUM_BLOCKS=1):
    BLOCK_SIZE = 14
...
def rnn_inference_amx(NUM_BLOCKS=1):
